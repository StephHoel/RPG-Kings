...
export const disciplinesSeed: Discipline[] = [
  ...
  {
    name: DISCIPLINE_ENUM.field_hockey,
    type: DISCIPLINE_TYPE.optional,
    skills: [],
    disciplines: [],
    stats: [STAT_ENUM.strength, STAT_ENUM.stamina],
  ...
  },
  {
    ...
    name: DISCIPLINE_ENUM.performing,
    type: DISCIPLINE_TYPE.optional,
    skills: [],
    disciplines: [],
    stats: [STAT_ENUM.intelligence],
  ...
  {
    name: DISCIPLINE_ENUM.game_production,
    type: DISCIPLINE_TYPE.optional,
    skills: [],
    disciplines: [],
    stats: [STAT_ENUM.intelligence],
  ...
  {
    name: DISCIPLINE_ENUM.programming,
    type: DISCIPLINE_TYPE.optional,
    skills: [],
    disciplines: [],
    stats: [STAT_ENUM.intelligence],
