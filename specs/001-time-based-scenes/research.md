# research.md — Pesquisas e decisões
...
Alternativas consideradas: usar um pequeno DSL ou Markdown enriquecido com
metadados; rejeitado por complexidade adicional sem benefício imediato.
...
Alternativas consideradas: modelo baseado em tempo contínuo; rejeitado por
maior complexidade na serialização e nos gatilhos.
...
Alternativas: sobrescrever saves (perde dados) ou manter múltiplas versões
no código (aumenta complexidade). A migração foi escolhida por segurança.
...
Alternativas: fila de eventos randômica ou baseada em probabilidade; rejeitado
por tornar resultados não determinísticos para QA manual.
